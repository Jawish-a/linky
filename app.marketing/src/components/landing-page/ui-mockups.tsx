...
export const ImageMockup = ({ className }: { className?: string }) => {
  return (
    <CoreBlockMock className={cn('relative !p-0 overflow-hidden', className)}>
      <img
        src="https://cdn.onelynk.sa/block-610e4b68-f485-4730-b374-8c69fcec6928/8fca8b36-3f2d-48be-9519-5bb566044cbb"
        className="absolute w-full h-full object-cover"
        alt=""
      />
    </CoreBlockMock>
...
export const LinkBoxMockup = ({
  ...
  > = {
    x: {
      icon: 'https://cdn.onelynk.sa/default-data/x-logo.png',
      title: 'X / Twitter',
      username: '@trylinky',
    },
    instagram: {
      icon: 'https://cdn.onelynk.sa/default-data/icons/instagram.svg',
      title: 'Instagram',
      username: '@trylinky',
    },
    linkedin: {
