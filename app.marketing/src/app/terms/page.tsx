    ...
    <div className="bg-[#FCFBF8] px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        ...
        <div className="mt-10 max-w-2xl prose">
          ...
          <h2 className="font-srf">4. Contests, Sweepstakes and Promotions</h2>
          <p>
          ...
          <h2 className="font-srf">6. Prohibited Uses</h2>
          <p>
          ...
          <h2 className="font-srf">7. Analytics</h2>
          <p>
            We may use third-party Service Providers to monitor and analyze the
            use of our Service.
          </p>
          <h2 className="font-srf">8. No Use By Minors</h2>
          <p>
          ...
          <h2 className="font-srf">9. Accounts</h2>
          <p>
          ...
          <h2 className="font-srf">10. Intellectual Property</h2>
          <p>
          ...
          <h2 className="font-srf">12. Termination</h2>
          <p>
          ...
          <h2 className="font-srf">13. Governing Law</h2>
          <p>
            These Terms shall be governed and construed in accordance with the
            laws of the United Kingdom, without regard to its conflict of law
            provisions.
          </p>
          <h2 className="font-srf">14. Changes To Service</h2>
          <p>
          ...
          <h2 className="font-srf">15. Amendments to Terms</h2>
          <p>
          ...
          <h2 className="font-srf">16. Waiver and Severability</h2>
          <p>
          ...
          <h2 className="font-srf">17. Acknowledgement</h2>
          <p>
